...
function Rn(e) {
    ...
    try {
        ...
        (D = r), (_e.transition = t), (j = n), !(j & 6) && yn();
    }
}
function Li() {
    (he = Kn.current), F(Kn);
...
function kn(e, n, t) {
    var r = D,
        l = _e.transition;
    try {
        (_e.transition = null), (D = 1), kd(e, n, t, r);
    } finally {
        (_e.transition = l), (D = r);
    }
    return null;
...
function qn() {
    if (rn !== null) {
        var e = Ts(br),
            ...
            t = D;
        try {
            if (((_e.transition = null), (D = 16 > e ? 16 : e), rn === null))
                var r = !1;
            else {
...
const Bd = ({ steps: e }) => {
    ...
    Yd = () => {
        const [e, n] = xe.useState(null),
            [t, r] = xe.useState(null),
            l = async () => {
                try {
                    const i = await (
        ...
        return (
            ...
            P.jsxs(P.Fragment, {
                children: [
                    P.jsx("header", {
                        children: P.jsx(Od, { onClick: () => r(null) }),
                    }),
                    P.jsx("main", {
                        className: "container",
                        children:
